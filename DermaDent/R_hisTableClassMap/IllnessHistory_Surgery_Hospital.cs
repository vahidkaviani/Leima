...
namespace DSoftClinicAssistant
{
    ...
    public partial class IllnessHistory_Surgery_Hospital
    {
        public decimal id_illness { get; set; }
        public string comment_Surgery { get; set; }
        public string comment_Hospital { get; set; }
        public string comment_attach { get; set; }
        public string Gestation_rate { get; set; }
        public string Abortion_rate { get; set; }
